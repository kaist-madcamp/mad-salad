    ...
    try {
      const newUser = await user.create({
        data: {
          ...
          accts: {
            create: [
              { name: "신한카드", type: "CHECKING" },
              { name: "삼성카드", type: "CHECKING" },
              { name: "롯데카드", type: "CHECKING" },
              { name: "현금", type: "CHECKING" },
              { name: "카카오뱅크", type: "CHECKING" },
              { name: "우리카드", type: "CHECKING" },
              { name: "현대카드", type: "CHECKING" },
              { name: "비씨카드", type: "CHECKING" },
            ],
          },
        },
      });
